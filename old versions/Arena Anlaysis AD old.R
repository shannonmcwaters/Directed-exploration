...
# I. Import (data wide format)
#read data in
OriginalBeeHorizonArena <- ArenaData

  read.csv("https://raw.githubusercontent.com/shannonmcwaters/Directed-exploration/main/BeeHorizonArena%20MASTER%20DATA%20-%20Sheet1%20(4).csv")
